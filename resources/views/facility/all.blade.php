    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Tüm Tesisler</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/">#</a></li>
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tesisler</a></li>
                        <li class="breadcrumb-item active">Tüm Tesisler</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        Aşağıdaki listede sistemde kayıtlı olan tüm tesisleri görüntüleyebilirsiniz. Yeni tesis eklemek için menüyü kullanın. Tesis üzerinde işlem yapmak için aksiyon menüsünü kullanın.
                    </p>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href="javascript:;" onclick="changeTitle({{$facility->id}})">Adını Değiştir</a>
                                      <a class="dropdown-item" href="javascript:;" onclick="deleteFacility({{$facility->id}})">Sil</a>
                                    </div>
                                  </div>
                            </td>
                        </tr>
